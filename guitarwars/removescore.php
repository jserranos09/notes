...
// this is set from the admin .php page as it gets selected
...
// Delete the score data from the database. limit makes sure to just delte 1.
      $query = "DELETE FROM aliens_abduction WHERE id = $id LIMIT 1";
...
// dont use PHPSELF because dont wamt to pass any data through the url from GET
    echo '<form method="post" action="removescore.php">';
    echo '<input type="radio" name="confirm" value="Yes" /> Yes ';
    echo '<input type="radio" name="confirm" value="No" checked="checked" /> No <br />';
    echo '<input type="submit" value="Submit" name="submit" />';
// the hidden form fields are sued to store the score data so it gets sent along as part of the POST request
