...
// Approve the score by setting the approved column in the database to 1
      $query = "UPDATE aliens_abduction SET approved = 1 WHERE id = $id";
...
// reports if the the score wasnt approve
...
// provides a link back tot the admin page
