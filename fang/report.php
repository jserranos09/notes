...
<?php
  ...
  if (isset($_POST['submit'])) {
    ...
    // links the inputs of the user to an array
    ...
    /*
    // sending an email. Array to where the form is going to be emailed to
    ...
    mail(where to send, the subject, message, where sent from)
